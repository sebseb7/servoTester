#ifndef __cdc_desc_H__
#define __cdc_desc_H__

#include <string.h>
#include "../rom/mw_usbd.h"
#include "../rom/mw_usbd_rom_api.h"
#include "../inc/app_usbd_cfg.h"
...
__attribute__ ((aligned(4))) const uint8_t VCOM_DeviceDescriptor[] = {
...
__attribute__ ((aligned(4))) const uint8_t VCOM_ConfigDescriptor[] = {
/* Configuration 1 */
...
__attribute__ ((aligned(4))) const uint8_t VCOM_StringDescriptor[] = {
